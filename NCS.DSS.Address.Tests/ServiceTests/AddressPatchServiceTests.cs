...
namespace NCS.DSS.Address.Tests.ServiceTests
{
    ...
    public class AddressPatchServiceTests
    {
        ...
        private Mock<ILogger<AddressPatchService>> _logger;
        [SetUp]
        public void Setup()
        {
            _jsonHelper = new JsonHelper();
            _log = new Mock<ILogger>();
            _logger = new Mock<ILogger<AddressPatchService>>();
            _addressPatchService = new AddressPatchService(_jsonHelper, _logger.Object);
