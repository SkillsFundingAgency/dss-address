...
namespace NCS.DSS.Address.GetAddressByIdHttpTrigger.Function
{
    public class GetAddressByIdHttpTrigger
    {
        ...
        {
            _logger.LogTrace("Function {FunctionName} has been invoked", nameof(GetAddressByIdHttpTrigger));
            ...
            _logger.LogTrace("Address successfully retrieved. Address GUID: {AddressId}", address.AddressId);
            _logger.LogTrace("Function {FunctionName} has finished invoking", nameof(GetAddressByIdHttpTrigger));
