...
namespace NCS.DSS.Address.PatchAddressHttpTrigger.Service
{
    public class AddressPatchService : IAddressPatchService
    {
        ...
        public AddressPatchService(IJsonHelper jsonHelper, ILogger logger)
        {
        ...
        public string Patch(string addressJson, AddressPatch addressPatch)
        {
            ...
            _logger.LogInformation("completed updating address json object with PATCH request. returning object back to caller");
            return obj.ToString();
